...
이 부분을 좀 수정하고 싶은데, # 1과 2 중 랜덤하게 둘 중 하나를 선택하도록해서  ssid 랑 address 를 변경해서 테스트 하도록 하고 싶어. 
next_test , 192.168.2.254
next_test_2, 192.168.3.254 

가 2개의 쌍이야. 랜덤하게 하도록 코드를 수정해
